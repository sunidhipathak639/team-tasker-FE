...
import { SelectSeparator } from "@/shared/components/select";
import { Collapsible, CollapsibleContent } from "../shared/components/collapsible";
  ...
  return (
    <Collapsible open={preferences.isOpenSidebar} onOpenChange={preferences.toggleOpenSidebar}>
      <CollapsibleContent asChild>
        <aside className="flex flex-col h-full w-[300px] bg-[#0a0a0a] data-[state=open]:animate-collapsible-w-down data-[state=closed]:animate-collapsible-w-up">
