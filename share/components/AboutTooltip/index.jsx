  ...
  <Tooltip
    ...
    renderContent={() => (
      <FeedbackDropdown>
        ...
        <FeedbackParagraph>
          This simplified team clone is built with React on the front-end and Node/TypeScript on the
          back-end.
        </FeedbackParagraph>
        ...
        <a href="https://github.com/oldboyxx/team_clone" target="_blank" rel="noreferrer noopener">
